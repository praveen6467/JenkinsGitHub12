...
public class LoginSteps {
 ...
 //   @Then("the user should be redirected to the MyAccount Page by passing email and password with excel row {string}")
    public void check_user_navigates_to_my_account_page_by_passing_email_and_password_with_excel_data(String rows) throws IOException
    {
        ...
        // ** Here 'rows' are coming from  'check_user_navigates' METHOD i,e it contains 'rows' as parameter
        //  Here rows -1 (minus one ) because  in Feature file we given  index starting from 1  on Scenario Outline
